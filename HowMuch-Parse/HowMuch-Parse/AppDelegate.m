...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.window.rootViewController = ({
        ...
        coordinator.signedIn = [DKParseAuth sharedInstance].authenticated;        
        coordinator.storage = [[ParseStorage alloc] init];
        coordinator.auth = [[DKAuthenticationParse alloc] init];
